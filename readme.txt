...
Tags: sticky posts, featured posts, wordpress posts, blog, gutenberg
...
By default, WordPress allows multiple sticky posts, which can quickly clutter your homepage and make it harder to manage featured content.

**Sticky Posts Limit** gives you full control by letting you define how many sticky posts you want to keep.

When the limit is exceeded:
- Only the latest sticky posts are kept
...
This ensures your homepage always stays clean, focused, and easy to manage.
...
= 1.0.0 =
* Initial release
* Set a limit for sticky posts
* Automatically removes older sticky posts beyond limit
* Includes settings page for user control
